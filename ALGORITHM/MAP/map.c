...
/*1节点*/	{	{2,1,FL_brige,FREE,NOSPEED,0,SEEK_default,PARK_default,HN_Rotate,0},{2,3,FL_default,PLATFORM_1,NOSPEED,30,NOTSEEK,NOTPARK,HN_Rotate,0},	\
						{2,5,FL_default,PLATFORM_1,NOSPEED,0,SEEK_default,NOTPARK,rot_LFL,0},	
					},	

/*2节点*/	{	{1,2,FL_slow,FREE,NOSPEED,0,SEEK_PesPlatform,PARK_default,HR_F,180},{3,4,FL_slow,BRIGE,NOSPEED,25,NOTSEEK,NOTPARK,HN_Rotate,0},	\
...
/*3节点*/	{	{2,1,FL_brige,FREE,NOSPEED,0,SEEK_default,PARK_default,HN_Rotate,0},{4,3,FL_default,FREE,NOSPEED,0,SEEK_PesPlatform,PARK_PesPlatform,HR_F,180},	\
...
/*6节点*/	{	{7,6,FL_default,FREE,COMMON_SPEED,50,SEEK_PesPlatform,PARK_PesPlatform,HR_F,180},{8,6,FL_default,FREE,COMMON_SPEED,60,SEEK_Collision,NOTPARK,HR_F,180},	\
						{14,15,FL_default,FREE,NOSPEED,0,SEEK4,PARK_pesR,HL,90},{5,2,FL_default,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,rot_LFL,0},	\
						{7,12,FL_default,FREE,COMMON_SPEED,50,SEEK_PesPlatform,PARK_PesPlatform,HR_F,180},{14,16,FL_default,FREE,NOSPEED,60,SEEK4,PARK_pesR,HR,90},\
						{42,14,FL_slow,DOOR_PUSH,NOSPEED,0,NOTSEEK,NOTPARK,HN_Rotate,0},{14,35,FL_default,FREE,NOSPEED,0,SEEK_PESR,NOTPARK,HN_Rotate,0},	\
						{14,17,FL_default,FREE,NOSPEED,60,SEEK4,PARK_pesR,HR,90},
					},                 
...
/*7节点*/	{	{12,11,FL_default,PLATFORM,COMMON_SPEED,330,SEEK_PesPlatform,PARK_PesPlatform,HN_Rotate,0},{6,14,FL_default,PLATFORM,NOSPEED,0,SEEK_default,PARK_pesR,HR,90},	\
						{12,10,FL_slow,PLATFORM,COMMON_SPEED,330,SEEK_PesPlatform,PARK_PesPlatform,HR_F,180},{6,42,FL_default,PLATFORM,NOSPEED,0,SEEK4,PARK_pesR,HR,90},	\
					},
	
/*8节点*/ {	{6,7,FL_slow,FREE,COMMON_SPEED,80,SEEK_default,PARK_pesR_300,HR,140},
					},
...
/*9节点*/	{	{10,12,FL_default,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate,0},{10,11,FL_default,FREE,NOSPEED,0,SEEK4,NOTPARK,rot_LFL,0},	\
						{5,6,FL_default,FREE,NOSPEED,0,SEEK_PESR,NOTPARK,HN_Rotate,0},{39,15,FL_slow,DOOR_PUSH,NOSPEED,0,NOTSEEK,NOTPARK,HN_Rotate,0},	\
						{5,2,FL_default,FREE,COMMON_SPEED,10,SEEK_DIGR,PARK_pesR_200,HR,135},{39,9,FL_slow,FREE,NOSPEED,0,SEEK_Collision,PARK_Door,HL,180}, \
						{40,14,FL_slow,DOOR_PUSH,NOSPEED,0,NOTSEEK,NOTPARK,HN_Rotate,0},{40,9,FL_slow,FREE,NOSPEED,0,SEEK_Collision,PARK_Door,HL,180},	\
						{15,31,FL_default,FREE,NOSPEED,50,SEEK_DIGL,NOTPARK,HN_Rotate,0},{31,32,FL_slow,FREE,COMMON_SPEED,100,SEEK_DIGR,PARK_pesR,HR,90},	\
						{39,30,FL_slow,DOOR_PUSH,NOSPEED,0,NOTSEEK,NOTPARK,HN_Rotate,0},{6,14,FL_default,FREE,COMMON_SPEED,80,SEEK_DIGL,PARK_pesL_300,HL,90},	\
						...
						{13,14,FL_default,FREE,NOSPEED,120,SEEK4,NOTPARK,HN_Rotate,0},
					},

/*10节点*/{	{12,10,FL_default,PLATFORM,NOSPEED,0,SEEK_PesPlatform,PARK_PesPlatform,HR_F,180},{9,5,FL_default,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate,0},	\
						...
						{11,10,FL_default,FREE,COMMON_SPEED,45,SEEK_Collision,NOTPARK,HR_F,180},{9,31,FL_default,FREE,COMMON_SPEED,30,SEEK_default,PARK_pesL,HL,90},	\
						{6,14,FL_default,FREE,COMMON_SPEED,120,SEEK_DIGL,PARK_pesL_300,HL,90},
					},         

/*11节点*/{	{10,9,FL_default,FREE,COMMON_SPEED,45,SEEK_PESL,NOTPARK,HN_Rotate,35},{10,12,FL_slow,FREE,NOSPEED,0,SEEK_default,PARK_pesL_250,HL,120},	\
						{10,6,FL_default,FREE,COMMON_SPEED,45,SEEK_PESL,NOTPARK,HN_Rotate,35},
					},

/*12节点*/{	{10,9,FL_default,PLATFORM,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate,0},{10,11,FL_default,PLATFORM,COMMON_SPEED,20,SEEK_default,PARK_pesL_150,HR,135},	\
						
						
					},

/*13节点*/{	{14,35,FL_default,FREE,NOSPEED,0,SEEK4,PARK_pesL_45,HL,45},{9,5,FL_default,FREE,NOSPEED,0,SEEK4,PARK_pesR_200,HL,135}, \
						{14,17,FL_default,FREE,NOSPEED,0,SEEK4,PARK_pesL_45,HR,45},{40,9,FL_default,DOOR_PUSH,NOSPEED,0,NOTSEEK,NOTPARK,HN_Rotate,0},	\
...
/*14节点*/{	{15,9,FL_default,FREE,NOSPEED,0,SEEK4,PARK_pesR,HL,90},{37,36,FL_default,FREE,NOSPEED,0,SEEK_PesPlatform,PARK_PesPlatform,HL,180},	\
						...
						{35,36,FL_default,FREE,NOSPEED,0,SEEK4,PARK_pesR,HR,90},{42,6,FL_default,DOOR_PUSH,NOSPEED,0,NOTSEEK,NOTPARK,HN_Rotate,0},	\
						...
						{34,30,FL_default,FREE,COMMON_SPEED,25,SEEK_DIGL,PARK_pesL_No,HL,90},{17,18,FL_default,FREE,COMMON_SPEED,95,SEEK_DIGL,PARK_pesL_No,HL,90},	\
            {16,44,FL_slow,ANGLE,NOSPEED,0,SEEK_default,PARK_pesR,HR,120},{17,20,FL_default,FREE,COMMON_SPEED,80,SEEK_DIGL,PARK_pesL_No,HL,90},		\
						{9,5,FL_default,FREE,NOSPEED,120,SEEK4,PARK_pesR_200,HL,135},{13,9,FL_default,FREE,NOSPEED,120,SEEK4,NOTPARK,HN_Rotate,0},
					},	

/*15节点*/{	{9,5,FL_default,FREE,NOSPEED,50,SEEK4,PARK_pesR,HL,90},{39,9,FL_default,DOOR_PUSH,NOSPEED,0,NOTSEEK,NOTPARK,HN_Rotate,0},	\
...
/*17节点*/{	{18,20,FL_default,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate,0},{18,19,FL_slow,FREE,NOSPEED,0,SEEK4,PARK_pesL,HL,90}, \
            {14,34,FL_default,FREE,COMMON_SPEED,90,SEEK_DIGR,PARK_pesR,HR,90},{43,44,FL_default,FREE,NOSPEED,0,SEEK_default,NOTPARK,HN_Rotate,0}, \
						{43,16,FL_slow,ANGLE,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate,0},{20,21,FL_default,FREE,NOSPEED,80,SEEK4,PARK_pesL_No,HL,90},	\
					},

/*18节点*/{	{20,21,FL_slow,FREE,NOSPEED,0,SEEK_DIGL,PARK_pesL_No,HL,90},{19,18,FL_slow,FREE,NOSPEED,0,SEEK_Collision,NOTPARK,HN_Rotate,0},	\
...
/*20节点*/{	{21,22,FL_default,FREE,COMMON_SPEED,30,SEEK4,PARK_pesL_No,HL,90},{18,17,FL_slow,FREE,NOSPEED,45,SEEK4,NOTPARK,HN_Rotate,0},		\
            {17,14,FL_default,FREE,COMMON_SPEED,70,SEEK4,PARK_pesR_No,HR,90},{18,19,FL_slow,FREE,NOSPEED,45,SEEK4,PARK_pesR,HR,90},	\
					},

					
/*21节点*/{	{22,23,FL_slow,FREE,NOSPEED,30,SEEK_default,PARK_pesR_50,HR,120},{20,18,FL_default,FREE,COMMON_SPEED,30,SEEK_default,PARK_pesR_No,HR,90},	\
					},

/*22节点*/{	{23,24,FL_slow,FREE,COMMON_SPEED,70,SEEK_default,PARK_pesR_150,HR,135},{21,20,FL_slow,FREE,NOSPEED,35,SEEK4,PARK_pesR_No,HR,90},	\
					},

/*23节点*/{	{24,23,FL_default,Peak,NOSPEED,0,NOTSEEK,PARK_PesPlatform,HR_F,180},{25,26,FL_sword,SWORD,NOSPEED,0,SEEK4,PARK_pesR,HR,90},\
						{22,21,FL_default,FREE,COMMON_SPEED,60,SEEK_default,PARK_pesL_50,HL,120},
					},
...
/*26节点*/{	{27,26,FL_default,UP_26_27,NOSPEED,0,NOTSEEK,PARK_PesPlatform,HR_F,180},{25,28,FL_slow,FREE,NOSPEED,0,SEEK4,PARK_pesR,HR,90},	\
					},
...
/*30节点*/{	{34,35,FL_slow,S_BOARD_DOUBLE,NOSPEED,0,SEEK4,PARK_pesR,HR,90},{50,28,FL_slow,SLOPE,NOSPEED,0,SEEK_DIGR,PARK_pesR_No,HR,90},	\
					},
...
/*35节点*/{	{36,35,FL_slow,FREE,NOSPEED,0,SEEK_Collision,NOTPARK,HN_Rotate,0},{14,37,FL_slow,FREE,NOSPEED,0,SEEK4,PARK_pesL,HR,90},	\
						...
						{6,5,FL_default,FREE,COMMON_SPEED,100,SEEK_default,PARK_pesL,HR,90},{14,13,FL_default,FREE,NOSPEED,0,SEEK4,PARK_pesR,HR,45},
					},
...
/*46节点*/  {	{47,46,FL_default,FREE,NOSPEED,0,SEEK_PesPlatform,PARK_PesPlatform,HR_F,180},	{43,16,FL_circular,BRIGE,NOSPEED,0,SEEK_PESR,NOTPARK,HN_Rotate,0},	\
...
/*49节点*/  {	{37,15,FL_default,FREE,COMMON_SPEED,30,SEEK_PesPlatform,PARK_PesPlatform,HR_F,180},{15,9,FL_default,FREE,COMMON_SPEED,20,SEEK4,PARK_pesL,HR,90},	\
						},
