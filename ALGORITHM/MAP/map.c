...
/*6节点*/	{	{7,6,FL_default,FREE,COMMON_SPEED,50,SEEK_PesPlatform,PARK_PesPlatform,HL_F,180},{8,6,FL_default,FREE,COMMON_SPEED,25,SEEK_Collision,NOTPARK,HL_F,180},	\
...
/*9节点*/	{	{10,12,FL_default,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate,0},{10,11,FL_default,FREE,NOSPEED,0,SEEK4,NOTPARK,rot_LFL,0},	\
						...
						{39,30,FL_slow,DOOR_CLICK,NOSPEED,0,NOTSEEK,NOTPARK,HN_Rotate,0},{6,14,FL_default,FREE,COMMON_SPEED,60,SEEK_DIGL,PARK_pesL,HL,90},	\
...
/*10节点*/{	{12,10,FL_default,PLATFORM,NOSPEED,0,SEEK_PesPlatform,PARK_PesPlatform,HL_F,180},{9,5,FL_default,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate,0},	\
						...
						{11,10,FL_default,FREE,COMMON_SPEED,20,SEEK_Collision,NOTPARK,HL_F,180},{9,31,FL_default,FREE,COMMON_SPEED,20,SEEK_default,PARK_pesL,HL,90},	\
...
/*14节点*/{	{15,9,FL_default,FREE,NOSPEED,0,SEEK4,PARK_pesR,HL,90},{37,36,FL_default,FREE,NOSPEED,0,SEEK_PesPlatform,PARK_PesPlatform,HL,180},	\
						...
						{34,30,FL_default,FREE,COMMON_SPEED,20,SEEK_DIGL,PARK_pesL_No,HL,90},{17,18,FL_default,FREE,COMMON_SPEED,60,SEEK_DIGL,PARK_pesL_No,HL,90},	\
...
/*15节点*/{	{9,5,FL_default,FREE,COMMON_SPEED,50,SEEK4,PARK_pesR,HL,90},{39,9,FL_default,DOOR_CLICK,NOSPEED,0,NOTSEEK,NOTPARK,HN_Rotate,0},	\
...
/*20节点*/{	{21,22,FL_default,FREE,COMMON_SPEED,20,SEEK4,PARK_pesL_No,HL,90},{18,17,FL_default,FREE,COMMON_SPEED,30,SEEK4,NOTPARK,HN_Rotate,0},		\
...
/*39节点*/	{ {15,31,FL_default,FREE,NOSPEED,0,SEEK_PESR,NOTPARK,HN_Rotate,0}, {9,5,FL_slow,FREE,NOSPEED,0,SEEK4,PARK_pesR,HL,90}, \
