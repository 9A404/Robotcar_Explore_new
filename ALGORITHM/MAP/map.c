...
/*9节点*/	{	{10,12,FL_default,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate,0},{10,11,FL_default,FREE,NOSPEED,0,SEEK4,NOTPARK,rot_LFL,0},	\
						...
						{39,30,FL_slow,DOOR_CLICK,NOSPEED,0,NOTSEEK,NOTPARK,HN_Rotate,0},{6,14,FL_default,FREE,COMMON_SPEED,80,SEEK_DIGL,PARK_pesL_300,HL,90},	\
...
/*23节点*/{	{24,23,FL_default,Peak,NOSPEED,0,NOTSEEK,PARK_PesPlatform,HL_F,180},{25,26,FL_default,SWORD_RUN,NOSPEED,0,SEEK4,PARK_pesR_back,HR,90},\
...
/*25节点*/{	{26,27,FL_slow,FREE,NOSPEED,0,SEEK4,PARK_pesL,HL,90},{28,50,FL_slow,SLOPE,NOSPEED,20,SEEK4,PARK_pesL,HL,90},{23,24,FL_slow,SWORD_RUN,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate,0},	\
