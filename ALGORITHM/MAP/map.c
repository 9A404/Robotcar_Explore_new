...
/*2节点*/	{	{1,2,FL_slow,FREE,NOSPEED,0,SEEK_PesPlatform,PARK_default,HL_180_F},{3,4,FL_slow,BRIGE,NOSPEED,0,NOTSEEK,NOTPARK,HN_Rotate},	\
...
/*3节点*/	{	{2,1,FL_brige,FREE,NOSPEED,0,SEEK_default,PARK_default,HN_Rotate},{4,3,FL_default,FREE,NOSPEED,0,SEEK_PesPlatform,PARK_PesPlatform,HL_180_F},	\
						{5,9,FL_slow,SLOPE,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate},{5,6,FL_slow,SLOPE,NOSPEED,0,SEEK_default,PARK_pesR,HR_135},	
					},		
	
/*4节点*/	{	{3,5,FL_slow,PLATFORM,NOSPEED,0,SEEK_default,NOTPARK,rot_RFL},	
					},

/*5节点*/	{	{2,1,FL_slow,S_BOARD,NOSPEED,0,SEEK_default,NOTPARK,HN_Rotate},{6,7,FL_default,FREE,NOSPEED,0,SEEK_PESR,NOTPARK,HN_Rotate},	\
						{6,8,FL_default,FREE,COMMON_SPEED,30,SEEK_default,NOTPARK,rot_RFL},{9,10,FL_default,FREE,NOSPEED,0,SEEK4,NOTPARK,HN_Rotate},	\
						{6,42,FL_default,FREE,NOSPEED,0,SEEK4,PARK_pesL_45,HL_90},{6,14,FL_default,FREE,NOSPEED,0,SEEK4,PARK_pesL_200,HL_90},
					},      

/*6节点*/	{	{7,6,FL_default,FREE,NOSPEED,0,SEEK_PesPlatform,PARK_PesPlatform,HL_180_F},{8,6,FL_default,FREE,COMMON_SPEED,40,SEEK_Collision,NOTPARK,HL_180_F},	\
						{14,15,FL_default,FREE,NOSPEED,0,SEEK4,PARK_pesR,HL_90},{5,2,FL_default,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,rot_LFL},	\
						{7,12,FL_default,FREE,COMMON_SPEED,40,SEEK_PesPlatform,PARK_PesPlatform,HL_180_F},{14,16,FL_default,FREE,COMMON_SPEED,60,SEEK4,PARK_pesR,HR_90},\
...
/*8节点*/ {	{6,7,FL_slow,FREE,COMMON_SPEED,50,SEEK_default,PARK_pesR_250,HR_135},
					},
...
/*9节点*/	{	{10,12,FL_default,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate},{10,11,FL_default,FREE,NOSPEED,0,SEEK4,NOTPARK,rot_LFL},	\
						...
						{40,14,FL_slow,DOOR,NOSPEED,0,NOTSEEK,NOTPARK,HN_Rotate},{40,9,FL_slow,FREE,NOSPEED,0,SEEK_Collision,PARK_Door,HL_180},	\
						...
						{39,30,FL_slow,DOOR,NOSPEED,0,NOTSEEK,NOTPARK,HN_Rotate},{6,14,FL_default,FREE,COMMON_SPEED,80,SEEK_DIGL,PARK_pesL_300,HL_90},	\
...
/*10节点*/{	{12,10,FL_default,PLATFORM,NOSPEED,0,SEEK_PesPlatform,PARK_PesPlatform,HL_180_F},{9,5,FL_default,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate},	\
						{9,40,FL_default,FREE,COMMON_SPEED,30,SEEK_default,PARK_pesL,HL_45},{9,39,FL_default,FREE,NOSPEED,0,SEEK_default,PARK_pesL,HL_105},	\
						...
						{11,10,FL_default,FREE,COMMON_SPEED,30,SEEK_Collision,NOTPARK,HL_180_F},{9,31,FL_default,FREE,COMMON_SPEED,30,SEEK_default,PARK_pesL,HL_90},	\
						{6,14,FL_default,FREE,COMMON_SPEED,120,SEEK_DIGL,PARK_pesL_300,HL_90},
					},         

/*11节点*/{	{10,9,FL_default,FREE,COMMON_SPEED,40,SEEK_PESL,NOTPARK,HR_35},{10,12,FL_slow,FREE,NOSPEED,0,SEEK_default,PARK_pesL_250,HL_120},	\
						{10,6,FL_default,FREE,COMMON_SPEED,50,SEEK_PESL,NOTPARK,HR_35},
					},

/*12节点*/{	{10,9,FL_default,PLATFORM,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate},{10,11,FL_default,PLATFORM,NOSPEED,0,SEEK_default,PARK_pesL,HR_120},	\
...
/*14节点*/{	{15,9,FL_default,FREE,NOSPEED,0,SEEK4,PARK_pesR,HL_90},{37,36,FL_default,FREE,NOSPEED,0,SEEK_PesPlatform,PARK_PesPlatform,HL_180},	\
						...
						{34,30,FL_default,FREE,COMMON_SPEED,15,SEEK_DIGL,PARK_pesL_No,HL_90},{17,18,FL_default,FREE,COMMON_SPEED,80,SEEK_DIGL,PARK_pesL_No,HL_90},	\
            {16,44,FL_slow,ANGLE,NOSPEED,0,SEEK_default,PARK_pesR,HR_120_F},{17,20,FL_default,FREE,COMMON_SPEED,80,SEEK_DIGL,PARK_pesL_No,HL_90},		\
						{9,5,FL_default,FREE,COMMON_SPEED,120,SEEK4,PARK_pesR_200,HL_135},
					},	

/*15节点*/{	{9,5,FL_default,FREE,COMMON_SPEED,50,SEEK4,PARK_pesR,HL_90},{39,9,FL_default,DOOR,NOSPEED,0,NOTSEEK,NOTPARK,HN_Rotate},	\
...
/*17节点*/{	{18,20,FL_default,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate},{18,19,FL_slow,FREE,NOSPEED,0,SEEK4,PARK_pesL,HL_90}, \
            {14,34,FL_default,FREE,COMMON_SPEED,65,SEEK_DIGR,PARK_pesR,HR_90},{43,44,FL_default,FREE,NOSPEED,0,SEEK_default,NOTPARK,HN_Rotate}, \
						{43,16,FL_slow,ANGLE,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate},{20,21,FL_default,FREE,COMMON_SPEED,70,SEEK4,PARK_pesL_No,HL_90},
					},
...
/*20节点*/{	{21,22,FL_default,FREE,COMMON_SPEED,25,SEEK4,PARK_pesL_No,HL_90},{18,17,FL_default,FREE,COMMON_SPEED,30,SEEK4,NOTPARK,HN_Rotate},		\
...
/*21节点*/{	{22,23,FL_default,FREE,COMMON_SPEED,30,SEEK_default,PARK_pesR,HR_120_F},{20,18,FL_default,FREE,COMMON_SPEED,20,SEEK_default,PARK_pesR_No,HR_90},	\
					},

/*22节点*/{	{23,24,FL_slow,FREE,COMMON_SPEED,50,SEEK_default,PARK_pesR_250,HR_145},{21,20,FL_default,FREE,COMMON_SPEED,35,SEEK4,PARK_pesR_No,HR_90},
					},

/*23节点*/{	{24,23,FL_default,Peak,NOSPEED,0,NOTSEEK,PARK_PesPlatform,HL_180_F},{25,26,FL_sword,SWORD,NOSPEED,0,SEEK4,PARK_pesR,HR_90},\
						{22,21,FL_default,FREE,COMMON_SPEED,40,SEEK_default,PARK_pesL_200,HL_120},
					},
	
/*24节点*/{	{23,25,FL_default,DOWNPLATFORM,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate},{23,22,FL_default,DOWNPLATFORM,NOSPEED,0,SEEK_default,PARK_pesL_200,HL_135},	\
						
					},

/*25节点*/{	{26,27,FL_slow,FREE,NOSPEED,0,SEEK4,PARK_pesL,HL_90},{28,50,FL_slow,SLOPE,NOSPEED,20,SEEK4,PARK_pesL,HL_90},	\

					},

/*26节点*/{	{27,26,FL_default,UP_26_27,NOSPEED,0,NOTSEEK,PARK_PesPlatform,HL_180_F},{25,28,FL_slow,FREE,NOSPEED,0,SEEK4,PARK_pesR,HR_90},
					},

/*27节点*/{	{26,25,FL_default,DOWN27_26,NOSPEED,20,SEEK4,PARK_pesR,HR_90},		\
					
					},

/*28节点*/{	{25,26,FL_slow,SLOPE,NOSPEED,0,SEEK4,PARK_pesL,HL_90},	{50,49,FL_default,FREE,COMMON_SPEED,10,SEEK4,PARK_pesL,HL_35},  \
           },
...
/*34节点*/{	{35,36,FL_slow,FREE,NOSPEED,0,SEEK4,PARK_pesL,HL_90},{30,50,FL_slow,S_BOARD_DOUBLE,COMMON_SPEED,40,NOTSEEK,NOTPARK,HN_Rotate},	\
					},
...
/*39节点*/	{ {15,31,FL_default,FREE,NOSPEED,0,SEEK4,NOTPARK,HN_Rotate}, {9,5,FL_slow,FREE,NOSPEED,0,SEEK4,PARK_pesR,HL_90}, \
							{9,40,FL_slow,FREE,NOSPEED,0,SEEK4,PARK_pesR_No,HL_120},
						},

/*40节点*/  {	{13,14,FL_default,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate},{9,6,FL_slow,FREE,NOSPEED,0,SEEK_DIGL,PARK_pesR_No,HL_120},	\
...
/*43节点*/  {	{44,14,FL_default,FREE,NOSPEED,0,SEEK_PESL,NOTPARK,HN_Rotate},{16,44,FL_slow,FREE,NOSPEED,0,NOTSEEK,NOTPARK,rot_LFL},	\
						  ...
						  {37,36,FL_slow,FREE,NOSPEED,0,SEEK_PesPlatform,PARK_PesPlatform,HL_180},{16,17,FL_circular,FREE,NOSPEED,0,SEEK_default,PARK_pesR,HR_135},
						},
...
/*46节点*/  {	{47,46,FL_default,FREE,NOSPEED,0,SEEK_PesPlatform,PARK_PesPlatform,HL_180_F},	{43,16,FL_circular,BRIGE,NOSPEED,0,SEEK_PESR,NOTPARK,HN_Rotate},	\
...
/*50节点*/  {	{28,25,FL_default,FREE,COMMON_SPEED,10,SEEK4,PARK_pesR_No,HR_90},{49,37,FL_default,FREE,COMMON_SPEED,30,SEEK4,PARK_pesR_200,HR_120},
						},
