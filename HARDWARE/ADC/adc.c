...
int sensorDigitalRank(u16 digitalValue)
{
	...
	switch(digitalValue)
	{
		...
		case 0x040: temp=20;break;    // 0000 0100 0000 ÖÐ¼ä
		case 0x060: temp=20;break;    // 0000 0110 0000 ÖÐ¼ä
		case 0x020: temp=20;break;    // 0000 0010 0000 ÖÐ¼ä
...
int sensorDigitalRank_Sword_run(u16 digitalValue)
{
	...
	switch(digitalValue)
	{
		case 0x30:  temp=14;break;			// 000000110000
	  case 0x818: temp=16;break;			// 100000011000
		case 0xc0c: temp=18;break;			// 110000001100
		case 0x606: temp=20;break;			// 011000000110		中间
		case 0xc303: temp=22;break;     // 001100000011
		case 0x181: temp=24;break;    // 000110000001
		case 0xc0: temp=26;break;    // 000011000000
